...
Validates that delete_task tool adheres to its defined contract.
"""

import pytest
import json

from src.tools.delete_task import delete_task_internal, get_tool_definition
from tests.utils.task_helpers import create_test_task


@pytest.mark.contract
@pytest.mark.asyncio
async def test_delete_task_input_schema_validation(mock_mcp_context, test_session):
    """
    Test: delete_task input schema validation

    Verifies that delete_task accepts inputs matching the defined schema.
    """
    # Get tool definition
    ...
    assert tool_def["function"]["name"] == "delete_task"
...
@pytest.mark.contract
@pytest.mark.asyncio
async def test_delete_task_output_schema_validation(mock_mcp_context, test_session):
    """
    Test: delete_task output schema validation

    Verifies that delete_task returns outputs matching the defined schema.
    """
    # Setup
...
@pytest.mark.contract
@pytest.mark.asyncio
async def test_delete_task_error_schema_validation(mock_mcp_context):
    """
    Test: delete_task error schema validation

    Verifies that delete_task returns errors matching the defined schema.
    """
...
@pytest.mark.contract
def test_delete_task_tool_definition_matches_contract():
    """
    Test: delete_task tool definition matches contract
